...
const ALLOWED_CONFIG_KEYS = new Set([
  ...
  "JITO_BUNDLE_URL",
  "JITO_TIP_PERCENT",
  "JITO_TIP_FLOOR_LAMPORTS",
  "JITO_TIP_CEILING_LAMPORTS",
...
const ENV_VAR_DEFS: EnvVarDef[] = [
  ...
  {
    key: "JITO_TIP_PERCENT",
    required: false,
    description: "Jito tip as a fraction of trade value (e.g. 0.001 = 0.1%). Clamped to floor/ceiling.",
    setIn: "Settings page",
  },
  {
    key: "JITO_TIP_FLOOR_LAMPORTS",
    required: false,
    description: "Minimum Jito tip in lamports regardless of trade size (e.g. 5000 = 0.000005 SOL).",
    setIn: "Settings page",
  },
  {
    key: "JITO_TIP_CEILING_LAMPORTS",
    required: false,
    description: "Maximum Jito tip in lamports regardless of trade size (e.g. 10000000 = 0.01 SOL).",
    setIn: "Settings page",
  },
  {
    key: "JITO_SIMULATION_ENABLED",
    required: false,
    description: "Pre-submission transaction simulation gate. Set to 'true' or 'false'.",
    setIn: "Settings page",
  },
  {
